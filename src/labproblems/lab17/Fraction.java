...
public class Fraction implements Comparable<Fraction>{
	...
	public int compareTo(Fraction otherFraction) {
		/* TODO:
		 * 		Use what you learned about the Comparable Interface
		 * 		to implement this method. 
		 * 
		 * 		See if you can use existing methods in this class to 
		 * 		compare this fraction against the other fraction
		 * 
		 * 		Recall the return values listed in the slides 
		 * 
		 */
	}
}